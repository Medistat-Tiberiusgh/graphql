...
| **Primary resource (CRUD)**          | UserMedication (id, atc, added_at) — a user's private list of tracked medications, linked to their profile and enriched with statistical insights                                                                                                                                                                                                                            |
